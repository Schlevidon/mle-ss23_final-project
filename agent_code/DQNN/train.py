...
from .globals import Transition, TRANSITION_HISTORY_SIZE, OPTIMIZER_PARAMS, EPS_START, EPS_DECAY, BATCH_SIZE, AVERAGE_REWARD_WINDOW, ACTIONS, ACTIONS_DICT
...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]):
    ...
    size = self.MODEL_TYPE.state_to_features(last_game_state, self).flatten().squeeze().shape
